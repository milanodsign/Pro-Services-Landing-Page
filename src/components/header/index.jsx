...
const HeaderComponent = () => {
  ...
  // Set target date to 24 hours from now - calculado solo una vez
  ...
  // Debug: mostrar valores del contador
  console.log("Contador:", { days, hours, minutes, seconds });
    ...
    <>
      ...
      <div
        className={`${styles.promoBanner} ${
          isScrolled ? styles.bannerHidden : ""
        }`}
      >
        <div className={styles.container}>
          ...
          <div>
            ...
            <div>
              <a href="tel:+17542079013" className="btnYellow">
                Llamar Ahora
              </a>
            </div>
          </div>
      ...
      {/* Header Menu Fixed */}
      <header
        className={`${styles.headerMenu} ${isScrolled ? styles.scrolled : ""}`}
      >
